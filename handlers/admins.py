...
async def pause(client: Client, message: Message):
    ...
    await message.reply_text("**MʋsɩcRoɓo𝓽:** ⏸ Mʋsɩc Pʌʋsɘɗ.")
...
async def resume(client: Client, message: Message):
    ...
    await message.reply_text("**MʋsɩcRoɓo𝓽:** ▶️ Mʋsɩc Rɘsʋɱɘɗ.")
...
async def admincache(client, message: Message):
    ...
    await message.reply_text("**MʋsɩcRoɓo:** ❇️ Aɗɱɩŋ cʌcʜɘ ʀɘʆʀɘsʜɘɗ!")
